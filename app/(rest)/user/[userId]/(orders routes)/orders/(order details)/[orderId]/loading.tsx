    ...
    <>
      <div className="flex items-center gap-10 pt-5">
        <div className="flex flex-col  gap-3">
          <Skeleton className="w-full md:min-w-[2rem] md:max-w-[380px] rounded-xl">
            <div className="h-[1rem] rounded-xl"></div>
          </Skeleton>
          <Skeleton className="w-full md:min-w-[300px] md:max-w-[380px] rounded-xl">
            <div className="h-[10rem] rounded-xl"></div>
          </Skeleton>
        </div>
        <div className="flex flex-col  gap-3">
          <Skeleton className="w-full md:min-w-[300px] md:max-w-[380px] rounded-xl">
