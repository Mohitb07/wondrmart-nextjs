  ...
  return (
    <div className="">
      ...
      {userCart.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 xl:gap-x-12 gap-y-10 items-start">
          {/* left section */}
          ...
          {/* right section */}
          <div className="space-y-5 md:sticky md:top-20 self-start">
